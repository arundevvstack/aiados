...
export default function Login() {
  ...
  return (
    <div className="min-h-screen bg-[#050505] flex items-center justify-center p-4 relative overflow-hidden font-jakarta">
      ...
      <div className="absolute top-[-20%] right-[-10%] w-[60%] h-[60%] bg-[#CE1B22] opacity-10 blur-[120px] rounded-full mix-blend-screen animate-pulse"></div>
      <div className="absolute bottom-[-20%] left-[-10%] w-[60%] h-[60%] bg-[#1A1A1A] opacity-80 blur-[120px] rounded-full"></div>
      ...
      <div className="w-full max-w-md z-10">
        ...
        <div className="bg-[#121212]/80 backdrop-blur-xl border border-white/5 rounded-2xl p-8 shadow-2xl">
          <h2 className="text-2xl font-bold text-white mb-2 font-syne">Welcome Back</h2>
          <p className="text-gray-400 text-sm mb-6">Enter your workspace to continue production.</p>
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <div>
              <div className="flex justify-between items-center mb-2">
                ...
                <button type="button" className="text-xs text-gray-500 hover:text-white transition-colors">Forgot?</button>
              </div>
              <input
                type="password"
                required
          ...
          <p className="mt-6 text-center text-sm text-gray-400">
            ...
            <button onClick={() => navigate('/signup')} className="text-white hover:text-[#CE1B22] transition-colors">
              Create one
            </button>
          </p>
        </div>
